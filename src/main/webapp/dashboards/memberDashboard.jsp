...
<div class="max-w-4xl mx-auto">
  <div class="flex justify-between items-center mb-6">
    <h2 class="text-2xl font-bold text-gray-800">Welcome, ${membre.username}</h2>
  ...
  <div class="bg-white shadow-md rounded-lg p-6 mb-6">
    ...
    <p class="text-gray-600">ID: <span class="font-medium">${membre.id}</span></p>
    <p class="text-gray-600">Username: <span class="font-medium">${membre.username}</span></p>
    <p class="text-gray-600">Name: <span class="font-medium">${membre.nom}</span></p>
  </div>
